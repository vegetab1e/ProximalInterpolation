...
Экземпляры класса `KdTree` некопируемые, но перемещаемые. Это можно легко изменить, добавив реализацию глубокого копирования дерева, т.е. его обход с созданием копий самих узлов (операции копирования по умолчанию, т.е. конструктор копирования и оператор присваивания копированием, создаваемые компилятором, сделают лишь копию умного указателя на корневой узел).
